...
public class ForLoop01 {
    ...
    public static void main(String[] args) {
        ...
        //2.Yol:
        for(int i=14; i>4; i--){if(i%2==0){System.out.print(i + " ");}}
        System.out.println();

        for (int i = 28 ; i<158 ; i++){ if (i%2!=0){System.out.print(i+" ");}}

        // example 7 : Java Stringini " J*a*v*a*" stringine çeviren kodu yazın
        System.out.println();// sout print'den sonra satır atlamak için
        String str = "Java";
        for (int i = 0  ; i<str.length()  ; i++  ) {System.out.print(str.charAt(i)+"*");}
        // i burada karakter indeksi

        System.out.println();
        // example 8: size verilen stringde tekrarsız karakterleri ekrana yazdırın
