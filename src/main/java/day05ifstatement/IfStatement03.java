...
public class IfStatement03 {
    ...
    public static void main(String[] args) {
        ...
        //3.Yol: daha sonra hoca anlatacak. bu soruyu bir daha ÇÖZ!!!
        ...
        if (haftaSonu) {
            ...
            // buradaki kodda true çalışır. false çalışmaz. her zaman öyledir.
            // parantez içine mümkün olduğunca sade yani çok az kod yazılır. dışarda daha çok tanımlanır herşey
        }
